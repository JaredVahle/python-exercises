...
middle_fruit =  [fruit for fruit in fruits if len(fruit) = 5]
print(middle_fruit)
# Exercise 7 - Make a list that contains fruits that have less than 5 characters
short_fruit =  [fruit for fruit in fruits if len(fruit) < 5]
print(short_fruit)
# Exercise 8 - Make a list containing the number of characters in each fruit. Output would be [5, 4, 10, etc... ]
len_of_fruit = [len(fruit) for fruit in fruits]
print(len_of_fruit)
...
is_prime = [primes(n) for n in numbers]
print(is_prime)